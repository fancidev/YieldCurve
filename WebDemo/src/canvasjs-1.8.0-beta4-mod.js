...
(function () {
	...
	Chart.prototype._updateOptions = function () {
		...
		this.updateOption("dataPointWidthRatio");
	...
	Chart.prototype.renderColumn = function (plotUnit) {
		...
		var barWidthRatio = this.dataPointWidthRatio ? this.dataPointWidthRatio : .9;
		var barWidth = this.dataPointWidth ? this.dataPointWidth : (((plotArea.width / Math.abs(plotUnit.axisX.viewportMaximum - plotUnit.axisX.viewportMinimum)) * Math.abs(xMinDiff)) / plotUnit.plotType.totalDataSeries * barWidthRatio) << 0;
		...
		for (var i = 0; i < entries.length; i++) {
			...
			if (dataPoint.highlightEnabled !== false && (dataSeries.highlightEnabled === true || dataPoint.highlightEnabled === true)) {
				...
				if (dataSeries.type === "line" || dataSeries.type === "stepLine" || dataSeries.type === "spline" || dataSeries.type === "scatter"
					...
					var highlightColor = typeof(dataPoint.highlightColor) !== 'undefined' ? dataPoint.highlightColor : 
					                     typeof(dataSeries.highlightColor) !== 'undefined' ? dataSeries.highlightColor :
					                     "red";
					var highlightOpacity = typeof(dataPoint.highlightOpacity) !== 'undefined' ? dataPoint.highlightOpacity : 
					                       typeof(dataSeries.highlightOpacity) !== 'undefined' ? dataSeries.highlightOpacity :
					                       .3;
					drawRect(overlaidCanvasCtx, eventObject.x1, eventObject.y1, eventObject.x2, eventObject.y2, highlightColor, 0, null, false, false, false, false, highlightOpacity);
				}
